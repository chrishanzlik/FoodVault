...
{
    /// <summary>
    /// Domain event which signals that a product has been removed to a store.
    /// </summary>
    public class ProductRemovedEvent : DomainEvent
    {
        ...
        public ProductRemovedEvent(FoodStoreId storeId, ProductId productId, int quantity)
        {
            FoodStoreId = storeId;
            ProductId = productId;
            Quantity = quantity;
        ...
        /// <summary>
        /// Gets the id of the <see cref="FoodStore"/> where the product was removed.
        /// </summary>
